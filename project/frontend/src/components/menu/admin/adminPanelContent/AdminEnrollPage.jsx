            ...
            if (selectedCourse) {
                try {
                    ...
                    const uniqueSubscribers = Array.from(
                        new Map(allSubscribers.map((user) => [user.id, user])).values()
                    );
        ...
        <div className="admin-enroll-courses-container">
            ...
            {selectedCourse && (
                <div className="course-info-panel">
                    ...
                    <p>
                        <strong>ID курса:</strong> {courseInfo.getId()}
                    </p>
                    <p>
                        <strong>Цена:</strong> {courseInfo.getPrice()}
                    </p>
                    <p>
                        <strong>Название:</strong> {courseInfo.getName()}
                    </p>
                    <button
                    ...
                    <button
                        className="button add-lesson-button"
                        ...
                        <ul>
                            {subscribers.map((user) => (
                                <li key={user.id} className="subscriber-item">
                                    ID: {user.id}, Логин:{" "}
                                    {user.login || "Логин отсутствует"}
                                    {ratingUserId !== user.id ? (
                                        <button
                                            className="rate-button"
                                            onClick={() => handleRate(user.id)}
                                        >
                                            Оценить
                                        </button>
                                    ) : (
